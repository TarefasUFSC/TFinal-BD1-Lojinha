  ...
  return knex('Compra').del()
    .then(function () {
      ...
      return knex('Compra').insert([
        ...
        {Data:parseInt(new Date(2021,07,04).getTime()/1000),id_Cliente:1,ValorFinal:300}, //Roupa de Grife masculina
        ...
        {Data:parseInt(new Date(2021,05,30).getTime()/1000),id_Cliente:3,ValorFinal:500}, //Roupa de Grife masculina
        ...
        {Data:parseInt(new Date(2021,07,27).getTime()/1000),id_Cliente:4,ValorFinal:603}, //Bermuda de praia Homem G e Bermuda de praia Mulher GG
