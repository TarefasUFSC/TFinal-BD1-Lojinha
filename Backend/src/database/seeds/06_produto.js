  ...
  return knex('Produto').del()
    .then(function () {
      ...
      return knex('Produto').insert([
        ...
        {id_Fornecedor:2,valor:15,Nome:"Skin de LoL","Descricao":"Skin Cassiopeia",Imagem:skinLol,Quantidade:43},
        ...
        {id_Fornecedor:1,valor:153,Nome:"Bermuda de praia Homem G",Imagem:bermuda1,Quantidade:19},
        ...
        {id_Fornecedor:2,valor:333,Nome:"Calça Jeans Feminina","Descricao":"Isso aqui ta rasgado não compre.... Tamanho M e azul",Imagem:calca2,Quantidade:42},
